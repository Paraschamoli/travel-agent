...
<h3 align="center">An AI-powered travel assistant that helps users plan trips by recommending destinations, creating itineraries, comparing travel options, and providing guidance on bookings, budgets, and local experiences—all in one place.</h3>

<p align="center">
  <strong>An AI-powered travel assistant that helps users plan trips by recommending destinations, creating itineraries, comparing travel options, and providing guidance on bookings, budgets, and local experiences—all in one place.</strong><br/>
  An AI-powered travel assistant that helps users plan trips by recommending destinations, creating itineraries, comparing travel options, and providing guidance on bookings, budgets, and local experiences—all in one place.
</p>

<p align="center">
  <a href="https://github.com/Paraschamoli/travel-agent/actions/workflows/main.yml?query=branch%3Amain">
    <img src="https://img.shields.io/github/actions/workflow/status/Paraschamoli/travel-agent/main.yml?branch=main" alt="Build status">
  </a>
  <a href="https://codecov.io/gh/Paraschamoli/travel-agent">
    <img src="https://codecov.io/gh/Paraschamoli/travel-agent/branch/main/graph/badge.svg" alt="codecov">
  </a>
...
**Perfect for:** An AI-powered travel assistant that helps users plan trips by recommending destinations, creating itineraries, comparing travel options, and providing guidance on bookings, budgets, and local experiences—all in one place.
...
- 📖 **[Full Documentation](https://Paraschamoli.github.io/travel-agent/)**
- 💻 **[GitHub Repository](https://github.com/Paraschamoli/travel-agent/)**
- 🐛 **[Report Issues](https://github.com/Paraschamoli/travel-agent/issues)**
...
gh repo create Paraschamoli/travel-agent --public --source=. --remote=origin --push
```
...
3. Then run:
```bash
git remote add origin https://github.com/Paraschamoli/travel-agent.git
...
```
travel-agent/
├── travel_agent/    # Main agent code
│   ├── skills/             # Agent capabilities
│   │   └── travel_agent/ # travel-agent skill
│   └── __init__.py
├── tests/                  # Test suite
├── docs/                   # Documentation
...
<p align="center">
  <a href="https://github.com/Paraschamoli/travel-agent">⭐ Star this repo</a> •
